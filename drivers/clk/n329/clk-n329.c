...
static const char *sel_apll[] __initconst = { 
				"adiv0_clk", "adiv1_clk",
				"adiv2_clk", "adiv3_clk",
				"adiv4_clk", "adiv5_clk",
				"adiv6_clk", "adiv7_clk", };
static const char *sel_upll[] __initconst = { 
				"udiv0_clk", "udiv1_clk",
				"udiv2_clk", "udiv3_clk",
				"udiv4_clk", "udiv5_clk",
				"udiv6_clk", "udiv7_clk", };
static const char *sel_adc_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"adc_aclk", "adc_uclk", };
static const char *sel_ado_src[] __initconst = {
				"xtal_clk", "reserved_clk",
				"ado_aclk", "ado_uclk", };
static const char *sel_vpost_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"vpost_aclk", "vpost_uclk", };
static const char *sel_sd_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"sd_aclk", "sd_uclk", };
static const char *sel_sen_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"sen_aclk", "sen_uclk", };
static const char *sel_usb_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"usb_aclk", "usb_uclk", };
static const char *sel_usb20_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"usb20_aclk", "usb20_uclk", };
static const char *sel_uart0_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"uart0_aclk", "uart0_uclk", };
static const char *sel_uart1_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"uart1_aclk", "uart1_uclk", };
static const char *sel_sys_src[] __initconst = { 
				"xtal_clk", "reserved_clk",
				"sys_aclk", "sys_uclk", };
static const char *sel_gpio_src[] __initconst = { 
				"xtal_clk", "rtx_clk", };
static const char *sel_kpi_src[] __initconst = { 
				"xtal_clk", "rtx_clk", };
...
static enum n329_clk clks_init_on[] __initdata = {
	...
	gpio_src, gpio_div, gpio_clk, cpu_div, cpu_clk,
...
static void __init n329_clocks_init(struct device_node *np)
{
	...
	clks[adc_aclk] = n329_clk_mux("adc_aclk", REG_CLKDIV3, 16, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[adc_uclk] = n329_clk_mux("adc_uclk", REG_CLKDIV3, 16, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[adc_src] = n329_clk_mux("adc_src", REG_CLKDIV3, 19, 2, 
					sel_adc_src, 
					ARRAY_SIZE(sel_adc_src));
	clks[adc_div] = n329_clk_source_div("adc_div", "adc_src", 
					REG_CLKDIV3, 24, 8);
	clks[adc_clk] = n329_clk_gate("adc_clk", "adc_div", REG_APBCLK, 0);

	/* ADO (Audio) engine clock generator */
	clks[ado_aclk] = n329_clk_mux("ado_aclk", REG_CLKDIV1, 16, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[ado_uclk] = n329_clk_mux("ado_uclk", REG_CLKDIV1, 16, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[ado_src] = n329_clk_mux("ado_src", REG_CLKDIV1, 19, 2, 
					sel_ado_src, 
					ARRAY_SIZE(sel_ado_src));
	clks[ado_div] = n329_clk_div("ado_div", "ado_src", 
					REG_CLKDIV1, 24, 8);
	clks[ado_clk] = n329_clk_gate("ado_clk", "ado_div", REG_AHBCLK, 30);

	/* LCD VPOST engine clock generator */
	clks[vpost_aclk] = n329_clk_mux("vpost_aclk", REG_CLKDIV1, 0, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[vpost_uclk] = n329_clk_mux("vpost_uclk", REG_CLKDIV1, 0, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[vpost_src] = n329_clk_mux("vpost_src", REG_CLKDIV1, 3, 2, 
					sel_vpost_src, 
					ARRAY_SIZE(sel_vpost_src));
	clks[vpost_div] = n329_clk_source_div("vpost_div", "vpost_src", 
					REG_CLKDIV1, 8, 8);
	clks[vpost_clk] = n329_clk_gate("vpost_clk", "vpost_div", 
					REG_AHBCLK, 27);
	clks[vpostd2_div] = n329_clk_fixed_div("vpostd2_div", 
					"vpost_div", 2);
	clks[vpostd2_clk] = n329_clk_gate("vpostd2_clk", "vpostd2_div", 
					REG_AHBCLK, 27);
	clks[vpost_hclk] = n329_clk_gate("vpost_hclk", "hclk4_clk", 
					REG_AHBCLK, 27);

	/* SD engine clock generator */
	clks[sd_aclk] = n329_clk_mux("sd_aclk", REG_CLKDIV2, 16, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[sd_uclk] = n329_clk_mux("sd_uclk", REG_CLKDIV2, 16, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[sd_src] = n329_clk_mux("sd_src", REG_CLKDIV2, 19, 2, 
					sel_sd_src, ARRAY_SIZE(sel_sd_src));
	clks[sd_div] = n329_clk_source_div("sd_div", "sd_src", 
					REG_CLKDIV2, 24, 8);
	clks[sd_clk] = n329_clk_gate("sd_clk", "sd_div", REG_AHBCLK, 23);

	/* Sensor clock generator */
	clks[sen_aclk] = n329_clk_mux("sen_aclk", REG_CLKDIV0, 16, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[sen_uclk] = n329_clk_mux("sen_uclk", REG_CLKDIV0, 16, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[sen_src] = n329_clk_mux("sen_src", REG_CLKDIV0, 19, 2, 
					sel_sen_src, ARRAY_SIZE(sel_sen_src));
	clks[sen_div] = n329_clk_source_div("sen_div", "sen_src", 
					REG_CLKDIV0, 24, 4);
	clks[sen_clk] = n329_clk_gate("sen_clk", "sen_div", REG_AHBCLK, 29);

	/* USB 1.1 48MHz clocks generator */
	clks[usb_aclk] = n329_clk_mux("usb_aclk", REG_CLKDIV2, 0, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[usb_uclk] = n329_clk_mux("usb_uclk", REG_CLKDIV2, 0, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[usb_src] = n329_clk_mux("usb_src", REG_CLKDIV2, 3, 2, 
					sel_usb_src, ARRAY_SIZE(sel_usb_src));
	clks[usb_div] = n329_clk_source_div("usb_div", "usb_src", 
					REG_CLKDIV2, 8, 4);
	clks[usb_clk] = n329_clk_gate("usb_clk", "usb_div", 
					REG_AHBCLK, 17);
	clks[usbh_hclk] = n329_clk_gate("usbh_hclk", "hclk3_clk", 
					REG_AHBCLK, 17);

	/* USB 2.0 PHY 12 MHz source clock generator */
	clks[usb20_aclk] = n329_clk_mux("usb20_aclk", REG_CLKDIV2, 5, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[usb20_uclk] = n329_clk_mux("usb20_uclk", REG_CLKDIV2, 5, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[usb20_src] = n329_clk_mux("usb20_src", REG_CLKDIV2, 21, 2, 
					sel_usb20_src, ARRAY_SIZE(sel_usb20_src));
	clks[usb20_div] = n329_clk_source_div("usb20_div", "usb20_src", 
					REG_CLKDIV2, 12, 4);
	clks[usb20_clk] = n329_clk_gate("usb20_clk", "usb20_div", 
					REG_AHBCLK, 18);
	clks[usb20_hclk] = n329_clk_gate("usb20_hclk", "hclk3_clk", 
					REG_AHBCLK, 18);

	/* UART 0 clock generator */
	clks[uart0_aclk] = n329_clk_mux("uart0_aclk", REG_CLKDIV3, 0, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[uart0_uclk] = n329_clk_mux("uart0_uclk", REG_CLKDIV3, 0, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[uart0_src] = n329_clk_mux("uart0_src", REG_CLKDIV3, 3, 2, 
					sel_uart0_src, 
					ARRAY_SIZE(sel_uart0_src));
	clks[uart0_div] = n329_clk_source_div("uart0_div", "uart0_src", 
					REG_CLKDIV3, 5, 3);
	clks[uart0_clk] = n329_clk_gate("uart0_clk", "uart0_div", 
					REG_APBCLK, 3);

	/* UART 1 clock generator */
	clks[uart1_aclk] = n329_clk_mux("uart1_aclk", REG_CLKDIV3, 8, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[uart1_uclk] = n329_clk_mux("uart1_uclk", REG_CLKDIV3, 8, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[uart1_src] = n329_clk_mux("uart1_src", REG_CLKDIV3, 11, 2, 
					sel_uart1_src, 
					ARRAY_SIZE(sel_uart1_src));
	clks[uart1_div] = n329_clk_source_div("uart1_div", "uart1_src", 
					REG_CLKDIV3, 13, 3);
	clks[uart1_clk] = n329_clk_gate("uart1_clk", "uart1_div", 
					REG_APBCLK, 4);

	/* System clock generator. */
	clks[sys_aclk] = n329_clk_mux("sys_aclk", REG_CLKDIV0, 0, 3, 
					sel_apll, ARRAY_SIZE(sel_apll));
	clks[sys_uclk] = n329_clk_mux("sys_uclk", REG_CLKDIV0, 0, 3, 
					sel_upll, ARRAY_SIZE(sel_upll));
	clks[sys_src] = n329_clk_mux("sys_src", REG_CLKDIV0, 3, 2, 
					sel_sys_src, 
					ARRAY_SIZE(sel_sys_src));
	clks[sys_clk] = n329_clk_source_div("sys_clk", "sys_src", 
					REG_CLKDIV0, 8, 4);

	/* GPIO clock generator */
	clks[gpio_src] = n329_clk_mux("gpio_src", REG_CLKDIV4, 16, 1, 
					sel_gpio_src, 
					ARRAY_SIZE(sel_gpio_src));
	clks[gpio_div] = n329_clk_div("gpio_div", "gpio_src", 
					REG_CLKDIV4, 17, 7);
	clks[gpio_clk] = n329_clk_gate("gpio_clk", "gpio_div", 
					REG_AHBCLK, 1);

	/* KPI clock generator */
	clks[kpi_src] = n329_clk_mux("kpi_src", REG_CLKDIV0, 5, 1, 
					sel_kpi_src, ARRAY_SIZE(sel_kpi_src));
	clks[kpi_div] = n329_clk_split_div("kpi_div", "kpi_src", 
					REG_CLKDIV0, 12, 4, 21, 3);
	...
	clks[hclk1_div] = n329_clk_table_div("hclk1_div", "cpu_div", 
						REG_CLKDIV4, 0, 1, 
						hclk1_div_table);
	clks[hclk234_div] = n329_clk_div("hclk234_div", "hclk_div", 
						REG_CLKDIV4, 4, 4);
	clks[hclk_clk] = n329_clk_gate("hclk_clk", "hclk_div", 
						REG_AHBCLK, 2);
	clks[hclk1_clk] = n329_clk_gate("hclk1_clk", "hclk1_div", 
						REG_AHBCLK, 8);
	clks[hclk2_clk] = n329_clk_and_gate("hclk2_clk", "hclk234_div", 
						REG_AHBCLK, 16, 24);
	clks[hclk3_clk] = n329_clk_gate("hclk3_clk", "hclk234_div", 
						REG_AHBCLK, 16);
	clks[hclk4_clk] = n329_clk_gate("hclk4_clk", "hclk234_div", 
						REG_AHBCLK, 24);

	/* JPG dividers and clocks */
	clks[jpg_div] = n329_clk_div("jpg_div", "hclk3_clk", 
						REG_CLKDIV4, 24, 3);
	clks[jpg_eclk] = n329_clk_gate("jpg_eclk", "jpg_div", 
						REG_APBCLK, 7);
	clks[jpg_hclk] = n329_clk_gate("jpg_hclk", "hclk3_clk", 
						REG_APBCLK, 7);

	/* Capture engine dividers and clocks */
	clks[cap_div] = n329_clk_div("cap_div", "hclk4_clk", 
						REG_CLKDIV4, 12, 3);
	clks[cap_eclk] = n329_clk_gate("cap_eclk", "cap_div", 
						REG_APBCLK, 28);
	clks[cap_hclk] = n329_clk_gate("cap_hclk", "hclk4_clk", 
						REG_AHBCLK, 28);

	/* EDMA controller clocks */
	clks[edma0_hclk] = n329_clk_gate("edma0_hclk", "hclk1_div", 
						REG_AHBCLK, 10);
	clks[edma1_hclk] = n329_clk_gate("edma1_hclk", "hclk1_div", 
						REG_AHBCLK, 11);
	clks[edma2_hclk] = n329_clk_gate("edma2_hclk", "hclk1_div", 
						REG_AHBCLK, 12);
	clks[edma3_hclk] = n329_clk_gate("edma3_hclk", "hclk1_div", 
						REG_AHBCLK, 13);
	clks[edma4_hclk] = n329_clk_gate("edma4_hclk", "hclk1_div", 
						REG_AHBCLK, 14);

	/* Frame switch controller clock*/
	clks[fsc_hclk] = n329_clk_gate("fsc_hclk", "hclk2_clk", 
						REG_AHBCLK, 6);

	/* Memory controller clocks */
	clks[dram_clk] = n329_clk_gate("dram_clk", "hclk_div", 
						REG_AHBCLK, 2);
	clks[sram_clk] = n329_clk_gate("sram_clk", "hclk_clk", 
						REG_AHBCLK, 3);
	clks[ddr_clk] = n329_clk_gate("ddr_clk", "sys_clk", 
						REG_AHBCLK, 4);

	/* Other HCLK3 derived clocks */
	clks[blt_hclk] = n329_clk_gate("blt_hclk", "hclk3_clk", 
						REG_AHBCLK, 5);
	clks[sic_hclk] = n329_clk_gate("sic_hclk", "hclk3_clk", 
						REG_AHBCLK, 21);
	clks[nand_hclk] = n329_clk_gate("nand_hclk", "hclk3_clk", 
						REG_AHBCLK, 22);

	/* Other HCLK4 derived clocks */
	clks[spu_hclk] = n329_clk_gate("spu_hclk", "hclk4_clk", 
						REG_AHBCLK, 25);
	clks[i2s_hclk] = n329_clk_gate("i2s_hclk", "hclk4_clk", 
						REG_AHBCLK, 26);
	clks[spu1_clk] = n329_clk_gate("spu1_clk", "hclk4_clk", 
						REG_AHBCLK, 31);

	/* APB clocks */
	clks[pclk_div] = n329_clk_div("pclk_div", "hclk1_clk", 
						REG_CLKDIV4, 8, 4);
	clks[pclk_clk] = n329_clk_gate("pclk_clk", "pclk_div", 
						REG_AHBCLK, 1);
	clks[adc_pclk] = n329_clk_gate("adc_pclk", "pclk_clk", 
						REG_APBCLK, 0);
	clks[i2c_pclk] = n329_clk_gate("i2c_pclk", "pclk_clk", 
						REG_APBCLK, 1);
	clks[rtc_pclk] = n329_clk_gate("rtc_pclk", "pclk_clk", 
						REG_APBCLK, 2);
	clks[uart0_pclk] = n329_clk_gate("uart0_pclk", "pclk_clk", 
						REG_APBCLK, 3);
	clks[uart1_pclk] = n329_clk_gate("uart1_pclk", "pclk_clk", 
						REG_APBCLK, 4);
	clks[pwm_pclk] = n329_clk_gate("pwm_pclk", "pclk_clk", 
						REG_APBCLK, 5);
	clks[spims0_pclk] = n329_clk_gate("spims0_pclk", "pclk_clk", 
						REG_APBCLK, 6);
	clks[spims1_pclk] = n329_clk_gate("spims1_pclk", "pclk_clk", 
						REG_APBCLK, 7);
	clks[timer0_pclk] = n329_clk_gate("timer0_pclk", "pclk_clk", 
						REG_APBCLK, 8);
	clks[timer1_pclk] = n329_clk_gate("timer1_pclk", "pclk_clk", 
						REG_APBCLK, 9);
	clks[wdt_pclk] = n329_clk_gate("wdt_pclk", "pclk_clk", 
						REG_APBCLK, 15);
	clks[tic_pclk] = n329_clk_gate("tic_pclk", "pclk_clk", 
						REG_APBCLK, 24);
	clks[kpi_pclk] = n329_clk_gate("kpi_pclk", "pclk_clk", 
						REG_APBCLK, 25);
