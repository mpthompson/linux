...
enum n329_clk {
	...
	adc_aclk, adc_uclk, adc_src, adc_div, adc_clk, ado_aclk,
	ado_uclk, ado_src, ado_div, ado_clk,
	vpost_aclk, vpost_uclk, vpost_src, vpost_div, vpost_clk,
	vpostd2_div, vpostd2_clk, vpost_hclk,
	sd_aclk, sd_uclk, sd_src, sd_div, sd_clk,
	sen_aclk, sen_uclk, sen_src, sen_div, sen_clk,
	usb_aclk, usb_uclk, usb_src, usb_div, usb_clk, usbh_hclk,
	usb20_aclk, usb20_uclk, usb20_src, usb20_div, usb20_clk, usb20_hclk,
	uart0_aclk, uart0_uclk, uart0_src, uart0_div, uart0_clk,
	uart1_aclk, uart1_uclk, uart1_src, uart1_div, uart1_clk,
	sys_aclk, sys_uclk, sys_src, sys_clk,
	gpio_src, gpio_div, gpio_clk,
	kpi_src, kpi_div, kpi_clk,
	cpu_div, cpu_clk,
	hclk_div, hclk1_div, hclk234_div, hclk_clk,
	hclk1_clk, hclk2_clk, hclk3_clk, hclk4_clk,
	jpg_div, jpg_eclk, jpg_hclk,
	cap_div, cap_eclk, cap_hclk,
	edma0_hclk, edma1_hclk, edma2_hclk, edma3_hclk, edma4_hclk,
	fsc_hclk, dram_clk, sram_clk, ddr_clk,
	blt_hclk, sic_hclk, nand_hclk, spu_hclk, i2s_hclk, spu1_clk,
	pclk_div, pclk_clk, adc_pclk,
	i2c_pclk, rtc_pclk, uart0_pclk, uart1_pclk, pwm_pclk,
	spims0_pclk, spims1_pclk, timer0_pclk, timer1_pclk,
	wdt_pclk, tic_pclk, kpi_pclk,
	clk_max
};
...
static void __init n329_clocks_init(struct device_node *np)
{
	...
	clks[adc_div] = n329_clk_div("adc_div", "adc_src", REG_CLKDIV3, 24, 8);
	...
	clks[vpost_div] = n329_clk_div("vpost_div", "vpost_src", REG_CLKDIV1, 8, 8);
	...
	clks[sd_div] = n329_clk_div("sd_div", "sd_src", REG_CLKDIV2, 24, 8);
	...
	clks[sen_div] = n329_clk_div("sen_div", "sen_src", REG_CLKDIV0, 24, 4);
	...
	clks[usb_div] = n329_clk_div("usb_div", "usb_src", REG_CLKDIV2, 8, 4);
	...
	clks[usb20_div] = n329_clk_div("usb20_div", "usb20_src", REG_CLKDIV2, 12, 4);
	...
	clks[uart0_div] = n329_clk_div("uart0_div", "uart0_src", REG_CLKDIV3, 5, 3);
	...
	clks[uart1_div] = n329_clk_div("uart1_div", "uart1_src", REG_CLKDIV3, 13, 3);
	...
	clks[sys_clk] = n329_clk_div("sys_clk", "sys_src", REG_CLKDIV0, 8, 4);
